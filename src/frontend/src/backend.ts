...
import type { FileId as _FileId, FileSystemEntry as _FileSystemEntry, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createFolder(arg0: string, arg1: FileId | null): Promise<FileId> {
        if (this.processError) {
            try {
    ...
    async getFileById(arg0: FileId): Promise<FileSystemEntry> {
        if (this.processError) {
            try {
                const result = await this.actor.getFileById(arg0);
                return from_candid_FileSystemEntry_n14(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getTextFileContent(arg0: FileId): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getTextFileContent(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listFilesByFolder(arg0: FileId | null): Promise<Array<FileSystemEntry>> {
        if (this.processError) {
            try {
    ...
    async storeTextFileContent(arg0: string, arg1: string, arg2: FileId | null): Promise<FileId> {
        if (this.processError) {
            try {
                const result = await this.actor.storeTextFileContent(arg0, arg1, to_candid_opt_n10(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateTextContent(arg0: FileId, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateTextContent(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_FileSystemEntry_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _FileSystemEntry): FileSystemEntry {
...
function from_candid_opt_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_FileId]): FileId | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        blobId: record_opt_to_undefined(from_candid_opt_n17(_uploadFile, _downloadFile, value.blobId)),
        uploadDate: value.uploadDate,
        textContent: record_opt_to_undefined(from_candid_opt_n17(_uploadFile, _downloadFile, value.textContent))
    };
}
...
function from_candid_vec_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_FileSystemEntry>): Array<FileSystemEntry> {
    return value.map((x)=>from_candid_FileSystemEntry_n14(_uploadFile, _downloadFile, x));
}
...
function to_candid_opt_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: FileId | null): [] | [_FileId] {
